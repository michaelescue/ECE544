...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/ME/OneDrive/Documents/School/PSU/Spring2020/ECE544/Projects/Project 0-Getting_Started/project_0/project_0.cache/compile_simlib/questa"
  fi
