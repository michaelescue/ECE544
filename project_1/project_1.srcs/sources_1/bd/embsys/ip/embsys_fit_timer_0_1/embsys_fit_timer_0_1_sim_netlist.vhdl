...
-- Date        : Wed Apr 22 01:48:58 2020
-- Host        : DESKTOP-J4B3MVP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/ME/Vivado_Projects/project_1/project_1.srcs/sources_1/bd/embsys/ip/embsys_fit_timer_0_1/embsys_fit_timer_0_1_sim_netlist.vhdl
...
entity embsys_fit_timer_0_1_Divide_part is
  port (
  ...
  attribute ORIG_REF_NAME of embsys_fit_timer_0_1_Divide_part : entity is "Divide_part";
end embsys_fit_timer_0_1_Divide_part;

architecture STRUCTURE of embsys_fit_timer_0_1_Divide_part is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \embsys_fit_timer_0_1_Divide_part__parameterized0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \embsys_fit_timer_0_1_Divide_part__parameterized0\ : entity is "Divide_part";
end \embsys_fit_timer_0_1_Divide_part__parameterized0\;

architecture STRUCTURE of \embsys_fit_timer_0_1_Divide_part__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \embsys_fit_timer_0_1_Divide_part__parameterized1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \embsys_fit_timer_0_1_Divide_part__parameterized1\ : entity is "Divide_part";
end \embsys_fit_timer_0_1_Divide_part__parameterized1\;

architecture STRUCTURE of \embsys_fit_timer_0_1_Divide_part__parameterized1\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \embsys_fit_timer_0_1_Divide_part__parameterized1_0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \embsys_fit_timer_0_1_Divide_part__parameterized1_0\ : entity is "Divide_part";
end \embsys_fit_timer_0_1_Divide_part__parameterized1_0\;

architecture STRUCTURE of \embsys_fit_timer_0_1_Divide_part__parameterized1_0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity embsys_fit_timer_0_1_FIT_timer is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute C_EXT_RESET_HIGH of embsys_fit_timer_0_1_FIT_timer : entity is 1;
  attribute C_FAMILY : string;
  attribute C_FAMILY of embsys_fit_timer_0_1_FIT_timer : entity is "artix7";
  attribute C_INACCURACY : integer;
  attribute C_INACCURACY of embsys_fit_timer_0_1_FIT_timer : entity is 0;
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of embsys_fit_timer_0_1_FIT_timer : entity is 2500;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of embsys_fit_timer_0_1_FIT_timer : entity is "FIT_timer";
end embsys_fit_timer_0_1_FIT_timer;

architecture STRUCTURE of embsys_fit_timer_0_1_FIT_timer is
  signal CE : STD_LOGIC;
...
begin
\Using_SRL16s.SRL16s[1].Divide_I\: entity work.embsys_fit_timer_0_1_Divide_part
     port map (
      CE => CE,
      Clk => Clk,
      Rst => Rst,
...
\Using_SRL16s.SRL16s[2].Divide_I\: entity work.\embsys_fit_timer_0_1_Divide_part__parameterized0\
     port map (
      CE => CE_0,
      CE_0 => CE,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[3].Divide_I\: entity work.\embsys_fit_timer_0_1_Divide_part__parameterized1\
     port map (
      CE => CE_2,
      CE_0 => CE_0,
      Clk => Clk,
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\embsys_fit_timer_0_1_Divide_part__parameterized1_0\
     port map (
      CE => CE_2,
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
...
entity embsys_fit_timer_0_1 is
  ...
  attribute NotValidForBitStream of embsys_fit_timer_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of embsys_fit_timer_0_1 : entity is "embsys_fit_timer_0_1,fit_timer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of embsys_fit_timer_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of embsys_fit_timer_0_1 : entity is "fit_timer,Vivado 2018.2";
end embsys_fit_timer_0_1;

architecture STRUCTURE of embsys_fit_timer_0_1 is
  attribute C_EXT_RESET_HIGH : integer;
...
begin
U0: entity work.embsys_fit_timer_0_1_FIT_timer
     port map (
      Clk => Clk,
      Interrupt => Interrupt,
      Rst => Rst
