...
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == clk}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == clk}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
set_false_path -from [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT0] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}] -to [get_clocks -of_objects [get_pins EMBSYS/clk_wiz_1/inst/mmcm_adv_inst/CLKOUT2] -filter {IS_GENERATED && MASTER_CLOCK == sys_clk_pin}]
