...
HD_PWD='C:/Users/ME/Vivado_Projects/project_1/project_1.runs/embsys_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_clk_wiz_1_1.tcl
