...
HD_PWD='C:/Users/ME/Vivado_Projects/project_1/project_1.runs/embsys_ilmb_v10_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_ilmb_v10_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_ilmb_v10_1.tcl
