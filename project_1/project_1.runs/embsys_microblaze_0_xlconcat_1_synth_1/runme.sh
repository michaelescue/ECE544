...
HD_PWD='C:/Users/ME/Vivado_Projects/project_1/project_1.runs/embsys_microblaze_0_xlconcat_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embsys_microblaze_0_xlconcat_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embsys_microblaze_0_xlconcat_1.tcl
